...
class usersDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'phoneNumber' => new Column(['title' => __('models/users.fields.phoneNumber'), 'data' => 'phoneNumber']),
            'address' => new Column(['title' => __('models/users.fields.address'), 'data' => 'address']),
            'sex' => new Column(['title' => __('models/users.fields.sex'), 'data' => 'sex']),
