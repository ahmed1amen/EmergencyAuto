...
@elseif ($menuItemHelper->isSearchBar($item))
    ...
    {{-- Search form --}}
    @include('vendor.adminlte.partials.sidebar.menu-item-search-form')

@elseif ($menuItemHelper->isSubmenu($item))

    {{-- Treeview menu --}}
    @include('vendor.adminlte.partials.sidebar.menu-item-treeview-menu')

@elseif ($menuItemHelper->isLink($item))

    {{-- Link --}}

    @include('vendor.adminlte.partials.sidebar.menu-item-link')
